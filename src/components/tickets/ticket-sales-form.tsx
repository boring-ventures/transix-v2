                        ...
                        <AccordionItem key={passenger.seatNumber} value={passenger.seatNumber}>
                          ...
                          <AccordionContent>
                            <div className="space-y-4 mt-2">
                              <div className="space-y-2">
                                <Label htmlFor={`fullName-${passenger.seatNumber}`}>Nombre completo</Label>
                                <Input
                                  id={`fullName-${passenger.seatNumber}`}
                                  value={passenger.fullName}
                                  onChange={(e) => {
                                    const newPassengers = formData.passengers.map(p => 
                                      p.seatNumber === passenger.seatNumber 
                              ...
                              <div className="space-y-2">
                                <Label htmlFor={`documentId-${passenger.seatNumber}`}>Documento de identidad</Label>
                                <Input
                                  id={`documentId-${passenger.seatNumber}`}
                                  value={passenger.documentId}
                                  onChange={(e) => {
                                    const newPassengers = formData.passengers.map(p => 
                                      p.seatNumber === passenger.seatNumber 
                                        ? { ...p, documentId: e.target.value }
                                        : p
                                    )
                                    updateFormData({ passengers: newPassengers })
                                  }}
