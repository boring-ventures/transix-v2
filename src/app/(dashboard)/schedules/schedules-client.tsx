...
export default function SchedulesClient() {
  ...
  const { schedules, isLoadingSchedules } = useSchedules({
    ...
    busId: filters.busId !== "all" ? filters.busId : undefined,
    status: filters.status !== "all" ? (filters.status as ScheduleStatus) : undefined,
    primaryDriverId: filters.primaryDriverId !== "all" ? filters.primaryDriverId : undefined,
  ...
  // Custom filter component for the DataTable
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4 mb-6">
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={(value) => handleFilterChange("primaryDriverId", value)}
        >
